...
function create_block_vikalpsangam_map_block_init() {
	...
	if ( ! file_exists( $script_asset_path ) ) {
		throw new Error(
			'You need to run `npm start` or `npm run build` for the "create-block/vikalpsangam-map" block first.'
		);
	}
	...
	wp_set_script_translations( 'create-block-vikalpsangam-map-block-editor', 'vikalpsangam-map' );
