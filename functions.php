...
class VikalpsangamOrgSite extends Timber\Site
{
  ...
  {
    $context["footer_logo"] = $this->get_template_image_url("/images/logo-alternate.png");
    ...
    $context["MAILCHIMP_SUBMIT_URL"] =
      "//vikalpsangam.us9.list-manage.com/subscribe/post?u=16f6762000d0db3e3e5190bf6&amp;id=4bd0241c3a";
  ...
  private function setup_common_context($context)
  {
    $context["post_categories"] = Timber::get_terms("category", [
      "hide_empty" => 1,
      "exclude" => [get_cat_ID("Perspectives"), get_cat_ID("Uncategorised"), get_cat_ID("Uncategorized")],
    ]);
  ...
  public function add_to_context($context)
  {
    ...
    add_filter("timber/twig", function (\Twig_Environment $twig) {
      $twig->addFunction(
        new \Twig\TwigFunction("get_sidebar", function () {
          return Timber::get_widgets("sidebar-1");
        })
      );

      $twig->addFunction(
        new \Twig\TwigFunction("get_social_icons", function () {
    ...
    add_filter("timber/twig", function (\Twig_Environment $twig) {
      $twig->addFunction(
        new \Twig\TwigFunction("get_secondary_header", function () {
    ...
    add_filter("timber/twig", function (\Twig_Environment $twig) {
      $twig->addFunction(
        new \Twig\TwigFunction("get_primary_header", function () {
          $navbar = buffer(function () {
            wp_nav_menu([
          ...
          $navbar = str_replace(
            self::$center_open . self::$center_close,
            self::$center_open . $logo . self::$center_close,
            $navbar
          );
...
$excluded_categories = [get_cat_ID("Perspectives"), get_cat_ID("Uncategorised"), get_cat_ID("Uncategorized")];
