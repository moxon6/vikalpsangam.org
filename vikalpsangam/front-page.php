...
<section class="top-carousel-wrapper">
    <div class="row no-right-margin">
        <div class="col-md-8 col-xs-12">
            <?php get_template_part( 'template-parts/carousel', null, [ "article_content" => $article_content ]); ?>
        </div>
        <div class="col-md-4 col-xs-12 featured-list">
            <?php get_template_part( 'template-parts/highlights', null, [ "article_content" => $article_content ]); ?>
        </div>
    </div>
</section>
