...
function vikalpsangam_scripts() {
	...
	wp_enqueue_script( 'vikalpsangam-stories-map/js-vue', get_template_directory_uri() . '/js/site/stories-map-vue.js', ["jquery", "wp-api"], random_int(PHP_INT_MIN, PHP_INT_MAX) );
